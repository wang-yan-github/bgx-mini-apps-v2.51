    ...
    app.ajax.req('workerproject_api_controller/getWokerInfo', data, 'POST', function(res) {
      ...
      if (parseInt(res.errorCode) == 200) {
        ...
        app.onLoadData("level", (data) => {
          let arr = codeToTextArr(data, strToArr(wokerInfo_temp.level));
          that.setData({
            level: arrToStr(arr)
          })
        });
        ...
        app.onLoadData("salary", (data) => {
          let arr = codeToTextArr(data, strToArr(wokerInfo_temp.salary));
          that.setData({
            salary: arrToStr(arr)
          })
        });
        ...
        app.onLoadData("consType", (data) => {
          let arr = codeToTextArr(data, strToArr(wokerInfo_temp.consType));
          that.setData({
            consType: arrToStr(arr)
          })
        });
        that.setData({
          ...
          // consType: parseTextCode(wokerInfo_temp.consType, 0),
